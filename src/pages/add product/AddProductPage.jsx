                        ...
                        <form id="addprod" noValidate>
                            <div className="row">
                                ...
                                <div className="col-md-4 mb-2">
                                    ...
                                    <input type="text" className="form-control input-text input-bg fs-7" name="product" id="product" required />
                                </div>
                                <div className="col-md-4 mb-2">
                                    <label htmlFor="sku" className="form-label head-text text-capitalize m-1 fs-7">sku number</label>
                                    <input type="text" className="form-control input-text input-bg fs-7" name="sku" id="sku" required />
                                </div>
                                <div className="col-md-4 mb-2">
                                ...
                                <div className="col-md-4 mb-2">
                                    ...
                                    <input type="text" className="form-control input-text input-bg fs-7" name="price" id="price" required />
                                </div>
                                <div className="col-md-4 mb-2">
                                    <label htmlFor="discountedPrice" className="form-label head-text text-capitalize m-1 fs-7">discounted price</label>
                                    <input type="text" className="form-control input-text input-bg fs-7" name="discountedPrice" id="discountedPrice" required />
                                </div>
                                <div className="col-md-4 mb-2">
                                    <label htmlFor="totalDiscount" className="form-label head-text text-capitalize m-1 fs-7">total discount</label>
                                    <input type="text" className="form-control input-text input-bg fs-7" name="totalDiscount" id="totalDiscount" required />
                                </div>
                                ...
                                <div className="col-md-12 mb-2">
                                    ...
                                    <textarea name="terms" id="terms" rows="7" className="form-control input-text input-bg fs-7"></textarea>
                                </div>
