        ...
        <>
          <div className="card border-0 " >
                <div className="position-relative">
                    ...
                    <h5 className="position-absolute bottom-0 start-0 card-title py-1 prime-bg px-2 text-capitalize fs-7 m-2 fw-semibold text-white rounded-pill">diamond earrings</h5>
                </div>
