      ...
      <div className="card border-0">
        <div className="p-3">
          <img
            ...
            alt=""
          />
          <h4 className="fs-6 m-0 fw-semibold prime-font mb-1 head-text">
            Robert Davis
          </h4>
          <p className="m-0 fs-7 mb-2 para-text">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Id fugiat,
            qui totam voluptatibus minus fugit architecto esse adipisci tenetur
            ea!
          </p>
