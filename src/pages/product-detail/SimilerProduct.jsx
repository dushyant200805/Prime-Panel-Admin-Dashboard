            ...
            return (
              <tr key={index}>
                  ...
                  <div className="d-flex gap-2">
                    ...
                    <div>
                      ...
                      <p className="m-0 text-capitalize para-text fs-7">
                        <span className="fw-semibold head-text">price:</span>{" "}
                        {item.Price}
                      </p>
                    </div>
                  </div>
                ...
                <td className="fs-7 d-flex gap-3">
                  <button className="btn btn-sm prime-btn">
                    <i className="bi bi-eye"></i>
                  </button>
                  <button className="btn btn-sm yellow-btn">
                    <i className="bi bi-heart"></i>
                  </button>
                  <button className="btn btn-sm second-btn">
