...
import { faCode, faMobileScreen, faUserClock, faChevronDown } from "@fortawesome/free-solid-svg-icons";
                                ...
                                <div className="card collapse-card  border-0 shadow-sm rounded-3">   
                                    ...
                                    <div id="accdetail" className="collapse p-2 show">   
                                        <div className="d-flex align-items-center gap-2">
                                            <img src="public/profile.jpg" width="100" height="100" className="rounded-3 object-fit-cover" alt=""/>   
                                            <div> 
                                                <h2 className="prime-font fs-6 fw-semibold text-capitalize head-text m-0 mb-2 head-text">Daniel Phillips</h2>
                                                <div className="d-flex flex-wrap gap-2 mb-2">
                                                    ...
                                                    <span className="rounded-3 prime-shade prime-text py-1 px-2 fs-7">
                                                        <FontAwesomeIcon icon={faUserClock} /> <span>3.5 Years</span>
                                                    </span>
                                                </div>
                                                <div className="d-flex flex-wrap gap-2">
                                                    ...
                                                    <Link to="tel:#" title="+1-0123456789" className="rounded-2 btn prime-btn d-flex align-items-center">
                                                        <FontAwesomeIcon icon={faMobileScreen} className="fs-6"/>
                                                    </Link> 
                                                </div> 
                                            </div>
                                        </div>  
                    ...
                    <div className="row g-3"> 
                        ...
                        <div className="col-sm-6 col-xl-12">
                            <div className="card currency-card  collapse-card h-100 border-0 shadow-sm rounded-3 position-relative">
                                <h2 className="fs-6 m-0 border-bottom light-border-bottom p-2 fw-bold text-capitalize d-flex justify-content-between align-items-center head-text"> convert</h2> 
                                <div className="p-3">
                                    <form action="" noValidate="noValidate">
                                        <div className="input-group mb-3">
                                            <input type="text" className="form-control input-bg input-text" placeholder="Select Currency" aria-label="Text input with dropdown button"/> 
                                        ...
                                        <div className="p-2 border light-border mb-3">  
                                                <div className="d-flex align-items-center justify-content-between border-bottom light-border-bottom pb-2 mb-2">
                                                    <h4 className="fs-7 text-capitalize head-text fw-bold m-0">dollar price : </h4>
                                                    <p className="fs-7 para-text m-0">$85</p>
                                                </div> 
                                                <div className="d-flex align-items-center justify-content-between border-bottom light-border-bottom pb-2 mb-2">
                                                    <h4 className="fs-7 text-capitalize head-text fw-bold m-0">euro price : </h4>
                                                    <p className="fs-7 para-text m-0">$97</p>
                                                </div> 
                                                <div className="d-flex align-items-center justify-content-between border-bottom light-border-bottom pb-2 mb-2">
                                                    <h4 className="fs-7 text-capitalize head-text fw-bold m-0">convert rate : </h4>
                                                    <p className="fs-7 para-text m-0">12</p>
                                                </div> 
                                                <div className="d-flex align-items-center justify-content-between">
                                                    <h4 className="fs-7 text-capitalize head-text fw-bold m-0">conversion price : </h4>
                                                    <p className="fs-7 para-text m-0">$120</p>
                                                </div> 
                                        </div>

                                        <button type="button" className="btn yellow-btn fw-bold rounded-1 w-100">convert</button>
                                    </form>
                                </div>
                            </div> 
                        </div> 
