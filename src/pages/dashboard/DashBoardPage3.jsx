...
import { faCode, faMobileScreen,faStar } from "@fortawesome/free-solid-svg-icons";
                ...
                <div className="card h-100 border-0 d-flex flex-column justify-content-center shadow-sm rounded-3">  
                        <div className="p-3">   
                                <div className="d-flex align-items-center gap-4">
                                    <img src="public/profile.jpg" width="100" height="100" className="rounded-pill object-fit-cover" alt=""/>   
                                    <div>
                                        <p className="prime-text fw-bold m-0 text-uppercase fs-7">welcome</p>
                                        <h2 className="prime-font fs-2 fw-medium text-capitalize head-text m-0 mb-2">Daniel Phillips</h2>
                                        <div className="d-flex align-items-center flex-wrap gap-2">
                                            <a href="#" className="rounded-pill second-bg text-white py-1 px-2">
                                                    <FontAwesomeIcon icon={faCode} /> Developer
                                            </a>
                                            <a href="#" className="rounded-pill blue-bg py-1 px-2">
                                                <FontAwesomeIcon icon={faStar} className="text-white"/> <span className="text-white">3 Yrs</span>
                                            </a>
                                            <a href="#" title="connect on instagram" className="rounded-pill icon-main red-bg">
                                                <FontAwesomeIcon icon={faInstagram} className="text-white"/>
                                            </a>
                                            <a href="#" title="connect on whatsapp" className="rounded-pill icon-main second-bg">
                                                <FontAwesomeIcon icon={faWhatsapp} className="text-white"/>
                                            </a>
                                            <a href="#" title="connect on twitter" className="rounded-pill icon-main blue-bg">
                                                <FontAwesomeIcon icon={faXTwitter} className="text-white"/>
                                            </a>
                                            <a href="tel:#" title="+1-0123456789" className="rounded-pill icon-main second-bg">
