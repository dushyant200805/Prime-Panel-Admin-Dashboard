...
function Header() {
  ...
  useEffect(() => {
    document.documentElement.setAttribute("data-bs-primetheme", theme);
  ...
  return (
    <>
      ...
      {loading && (
        <div id="preloader">
          <img src="/preloader.gif" width="40" alt="" className="me-2" />
      ...
      <div className="header-main mb-3">
        <nav
          className="navbar navbar-expand-lg navbar-dark card-bg rounded-3"
                ...
                <ul className="navbar-nav justify-content-end gap-3 align-items-center flex-grow-1">
                  <li className="nav-item">
                    <div className="maximize d-none d-lg-block">
                      <Link
                        to="#"
                        className="badge-purple d-flex align-items-center text-primary icon-main"
                        id="fullscreen"
                  ...
                  <li className="nav-item position-relative nav-drop">
                    ...
                    <div className="card rounded-3 nav-drop-item">
                      <h3 className="border-bottom mb-2 fs-6 fw-bold text-uppercase p-2 head-text">
                        view apps
                      </h3>
                      <div className="d-flex justify-content-between gap-1 menu-box flex-wrap">
                        <a href="#" className="menu-box-item red-box">
                          <BiGrid />
                          <p className="fs-9 text-uppercase fw-semibold m-0">
                            likes
                          </p>
                        </a>
                      ...
                      <div className="p-2">
                        <button className="btn prime-btn rounded-1 w-100">
                          view more
                        </button>
                      </div>
                    </div>
      ...
      {/* Cart Canvas */}
      <div
        className="offcanvas offcanvas-end card-bg "
        tabIndex="-1"
        id="prodcart"
        aria-labelledby="prodcartLabel"
      >
        <div className="offcanvas-header border-bottom light-border-bottom d-flex justify-content-between align-items-center p-2">
          <h5 className="offcanvas-title head-text" id="prodcartLabel">
            Cart Details
          </h5>
          <button
            type="button"
        ...
        <div className="offcanvas-body p-2">
          <div className="prod-cart mb-2 border light-border position-relative">
            <div className="position-absolute end-0 top-0">
              <Link to="#" title="remove from cart" className="para-text">
          ...
          <div className="border-top light-border-top">
            <table className="table prod-cart-table">
              ...
              <tbody>
                ...
                <tr>
                  <th scope="row" colSpan="4" className="text-end fw-bold">
                    Grand Total
                  </th>
            ...
            <div className="text-end">
              <button className="btn prime-btn btn-lg w-100">
                proceed to checkout
