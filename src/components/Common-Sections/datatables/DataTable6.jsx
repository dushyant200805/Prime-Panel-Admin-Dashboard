          ...
          <tr key={item.id}>
            ...
            <td>
              <div className="progress">
                <div
                  className={`progress-bar progress-bar-striped ${item.progressClass}`}
                  role="progressbar"
