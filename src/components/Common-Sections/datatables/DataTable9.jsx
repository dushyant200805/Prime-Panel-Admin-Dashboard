            ...
            return (
              <tr key={index}>
                  ...
                  <div className="d-flex gap-3">
                    ...
                    <div>
                      ...
                      <p className="m-0 text-capitalize para-text">
                        <span className="fw-semibold head-text">color:</span>{" "}
                        {item.color}
                      </p>
                      <p className="m-0 text-capitalize para-text">
                        <span className="fw-semibold head-text">size:</span>{" "}
                        {item.size}
                      </p>
                      <p className="m-0 text-capitalize para-text">
                        <span className="fw-semibold head-text">discount:</span>
                        <span className="second-text fw-semibold fs-8">
                          {" "}
                          {item.Discount}
                        </span>
                      </p>
                ...
                <td className="text-center">
                  <span className="second-shade border second-border px-2 rounded-pill fw-semibold fs-8 second-text">
                    {item.Stock}
                  </span>
                </td>
                <td>
                ...
                <td className="actions text-center gap-2">
                  <button className="ms-2 btn blue-btn btn-sm rounded-1">
                    <i className="bi bi-pencil-square"></i>
                  </button>
                  <button className="ms-2 btn tertiary-btn btn-sm rounded-1">
                    <i className="bi bi-heart"></i>
                  </button>
                  <button className="ms-2 btn red-btn btn-sm rounded-1">
