  ...
  return (
        <div className="card collapse-card border-0 shadow-sm rounded-3"> 
            <div className="text-end">
                {showTitle && <h2 className="fs-6 m-0 border-bottom light-border-bottom p-2 fw-bold text-capitalize d-flex justify-content-between align-items-center head-text">profit 
